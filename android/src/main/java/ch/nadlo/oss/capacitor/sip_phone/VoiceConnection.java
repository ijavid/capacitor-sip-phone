...
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_ANSWER_CALL;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_AUDIO_SESSION;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_DID_CHANGE_AUDIO_ROUTE;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_DTMF_TONE;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_END_CALL;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_HOLD_CALL;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_MUTE_CALL;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_ON_SILENCE_INCOMING_CALL;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_SHOW_INCOMING_CALL_UI;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_UNHOLD_CALL;
import static ch.nadlo.oss.capacitor.sip_phone.Constants.ACTION_UNMUTE_CALL;
...
public class VoiceConnection extends Connection {
    ...
    public void onDisconnect() {
        ...
        try {
            ((SipPhoneConnectionService) context).deinitConnection(handle.get(EXTRA_CALL_UUID));
        } catch (Throwable exception) {
